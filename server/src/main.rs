...
async fn main() -> anyhow::Result<()> {
    ...
    HttpServer::new(move || {
        ...
        App::new()
            ...
            .route("/_dashboard", web::get().to(handlers::show_home_page))
            .route(
                "/_dashboard/sessions",
            ...
            // Intercept hub
            .route(
                "/_dashboard/sessions/{id}/intercept",
                web::get().to(handlers::show_intercept_page),
            )
            // WebFetch Intercept
            .route(
                "/_dashboard/sessions/{id}/intercept/webfetch",
            ...
            .route(
                "/_dashboard/sessions/{id}/intercept/webfetch/clear",
                web::post().to(handlers::clear_webfetch_intercept_post),
            )
            .route(
                "/_dashboard/sessions/{id}/intercept/webfetch/whitelist",
                web::post().to(handlers::set_webfetch_whitelist_post),
            )
            .route(
                "/_dashboard/sessions/{id}/intercept/webfetch/whitelist/clear",
                web::post().to(handlers::clear_webfetch_whitelist_post),
            )
            // Pending Approvals
            .route(
                "/_dashboard/sessions/{id}/intercept/approvals",
                web::get().to(handlers::show_approvals_page),
            )
            .route(
                "/_dashboard/sessions/{id}/intercept/approvals/fail/{approval_id}",
                web::post().to(handlers::fail_approval_post),
            )
            .route(
                "/_dashboard/sessions/{id}/intercept/approvals/mock/{approval_id}",
                web::post().to(handlers::mock_approval_post),
            )
            .route(
                "/_dashboard/sessions/{id}/intercept/approvals/accept/{approval_id}",
